...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
  ...
  <body class="bg-slate-50 font-sans text-slate-800 selection:bg-teal-100 flex flex-col min-h-screen">
    <!-- Navigation -->
    <nav class="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-100 transition-all duration-300">
      <div class="max-w-7xl mx-auto px-6 py-4 w-full flex justify-between items-center">
        <div class="flex items-center text-teal-600 group cursor-pointer" onclick="window.scrollTo(0, 0)">
          <div
          ...
          <span class="text-2xl font-bold tracking-tight text-slate-800">Med<span
              class="text-teal-600">tracker</span></span>
        </div>
        <div class="hidden md:flex space-x-8 text-sm font-semibold text-slate-600">
          ...
          <a href="#map" class="hover:text-teal-600 transition">Find Medicine</a>
          <a href="#features" class="hover:text-teal-600 transition">Features</a>
        </div>
        <div class="flex items-center space-x-4">
          <a href="login.jsp" class="text-sm font-bold text-slate-600 hover:text-teal-600 transition">Log In</a>
          <a href="register.jsp"
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
          <div class="space-y-8 animate-fade-in-up">
            ...
            <h1 class="text-5xl md:text-7xl font-extrabold tracking-tight text-slate-900 leading-[1.1]">
              ...
              <span class="text-transparent bg-clip-text bg-gradient-to-r from-teal-600 to-emerald-600">in
                Kigali.</span>
            </h1>
            ...
            <div class="flex flex-col sm:flex-row gap-4 pt-4">
              <a href="#map"
                ...
                Locate Medicine
                <i data-lucide="map-pin" class="ml-2 group-hover:animate-bounce" width="20"></i>
              </a>
              <a href="#about"
          ...
          <div class="relative hidden lg:block">
            <div
              class="absolute -inset-4 bg-gradient-to-r from-teal-500 to-emerald-500 rounded-full opacity-20 blur-3xl animate-pulse">
            </div>
            <img src="https://images.unsplash.com/photo-1576091160550-217358c7e618?auto=format&fit=crop&q=80&w=800"
      ...
      <div class="max-w-7xl mx-auto px-6">
        <div class="text-center max-w-3xl mx-auto mb-16">
          ...
          <p class="text-slate-500 text-lg leading-relaxed">
            ...
            <span class="text-teal-600 font-semibold">Kigali and throughout Rwanda.</span>
        ...
        <div class="grid md:grid-cols-3 gap-8">
          <div class="bg-slate-50 p-8 rounded-2xl border border-slate-100 hover:shadow-lg transition duration-300">
            <div class="bg-blue-100 w-12 h-12 rounded-xl flex items-center justify-center text-blue-600 mb-6">
          ...
          <div class="bg-slate-50 p-8 rounded-2xl border border-slate-100 hover:shadow-lg transition duration-300">
            <div class="bg-teal-100 w-12 h-12 rounded-xl flex items-center justify-center text-teal-600 mb-6">
          ...
          <div class="bg-slate-50 p-8 rounded-2xl border border-slate-100 hover:shadow-lg transition duration-300">
            <div class="bg-purple-100 w-12 h-12 rounded-xl flex items-center justify-center text-purple-600 mb-6">
    ...
    <section id="map" class="py-24 bg-slate-50 relative">
      <div class="max-w-7xl mx-auto px-6">
        <div class="flex flex-col md:flex-row justify-between items-end mb-12">
          <div>
            <span class="text-teal-600 font-bold tracking-wider uppercase text-sm">Kigali Live Map</span>
        ...
        <div class="bg-white p-2 rounded-3xl shadow-xl border border-slate-200">
          <div id="pharmacy-map" class="h-[500px] w-full rounded-2xl z-10"></div>
        </div>
      </div>
    </section>
      ...
      <div class="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-2 text-sm">
            <li>
              <a href="#" class="hover:text-teal-400 transition">Search Medicine</a>
            </li>
            <li>
              <a href="#" class="hover:text-teal-400 transition">Map View</a>
            </li>
            <li>
              <a href="login.jsp" class="hover:text-teal-400 transition">Pharmacy Login</a>
            </li>
          </ul>
        </div>
        <div>
          ...
          <ul class="space-y-2 text-sm">
            <li>
              <a href="#" class="hover:text-teal-400 transition">support@medtracker.rw</a>
            </li>
            <li>
              <a href="#" class="hover:text-teal-400 transition">+250 788 123 456</a>
            </li>
          </ul>
        </div>
      </div>
