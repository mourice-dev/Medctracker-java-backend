                    ...
                    <main class="flex-1 overflow-y-auto p-6 bg-slate-50">
                        <div class="max-w-7xl mx-auto space-y-6">
                            ...
                            <% // Mock Data for Staff List<Map<String, String>> staffList = new ArrayList<>();
                                    Map<String, String> s1 = new HashMap<>(); s1.put("id", "1"); s1.put("name", "Dr.
                                            Ayesha Rao"); s1.put("role", "Cardiologist"); s1.put("department",
                                            "Cardiology"); s1.put("shift", "08:00 - 16:00"); s1.put("status", "On
                                            Duty"); staffList.add(s1);
                                            Map<String, String> s2 = new HashMap<>(); s2.put("id", "2"); s2.put("name",
                                                    "Dr. John Smith"); s2.put("role", "General Practitioner");
                                                    s2.put("department", "General Medicine"); s2.put("shift", "09:00 -
                                                    17:00"); s2.put("status", "In Surgery"); staffList.add(s2);
                                                    Map<String, String> s3 = new HashMap<>(); s3.put("id", "3");
                                                            s3.put("name", "Nurse Clara Wu"); s3.put("role", "Senior
                                                            Nurse"); s3.put("department", "ER"); s3.put("shift", "07:00
                                                            - 19:00"); s3.put("status", "On Duty"); staffList.add(s3);
